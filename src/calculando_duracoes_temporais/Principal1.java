package calculando_duracoes_temporais;
...
public class Principal1 {
    ...
    public static void main(String[] args) {
        ...
        Duration tempoEntrega = Duration.between(dataHoraCompra, dataHoraEntrega); /* vai calcular a duração de um tempo pro outro */
