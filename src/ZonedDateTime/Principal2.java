...
//                .withZoneSameLocal(ZoneId.of("America/Los_Angeles"));
        ...
        System.out.println(dataFestaSaoPaulo.equals(dataFestaLosAngeles)); // o conteudo é diferente
        System.out.println(dataFestaSaoPaulo.isEqual(dataFestaLosAngeles)); // vai comparar o instante especifico
    }
