...
public class Principal1 {
	...
	/* Month - só usaremos ela quando formos trabalhar apenas com mes */
...
//                TextStyle.FULL, new Locale("pt", "BR")));
		...
		System.out.println(DateTimeFormatter.ofPattern("MMMM").withLocale(new Locale("pt", "BR")).format(mes));
	}
