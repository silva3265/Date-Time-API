package Desafio_trabalhando_com_fuso_horário;
...
public class ConviteFesta {
	...
	private static final DateTimeFormatter FORMATADOR_COMPLETO = DateTimeFormatter
			.ofPattern("dd 'de' MMMM 'de' yyyy 'às' HH:mm (zzzz)").withLocale(new Locale("pt", "BR"));
	...
	public static void main(String[] args) {
		...
		ZonedDateTime dataFestaFusoPadrao = dataLocalFesta.atTime(horaLocalFesta).atZone(ZoneId.systemDefault());

		ZonedDateTime dataFestaSaoPaulo = dataFestaFusoPadrao.withZoneSameInstant(ZoneId.of("America/Sao_Paulo"));

		ZonedDateTime dataFestaLosAngeles = dataFestaFusoPadrao.withZoneSameInstant(ZoneId.of("America/Los_Angeles"));

		ZonedDateTime dataFestaJapao = dataFestaFusoPadrao.withZoneSameInstant(ZoneId.of("Japan"));
